...
class CreateTask extends Binder {
  constructor(props) {
    ...
    this.state = {
       ...
       */
       ...
       , backup: _.cloneDeep(this.props.defaultTask.obj)
    }
    this._bind(
      '_handleFormChange'
      , '_handleFormSubmit'
  ...
  componentDidMount() {
    ...
    console.log('testmeaaaa', loggedInUser);
  }
  ...
  _handleFormSubmit(e) {
    ...
    console.log('testasdsada', this.props);
